...
import com.example.yazidnaufalhudzami_41522010078_tugasbesar2.model.Student;
...
public class StudentQueryImplementation implements com.example.yazidnaufalhudzami_41522010078_tugasbesar2.database.QueryContract.StudentQuery {

    private DatabaseHelper databaseHelper = DatabaseHelper.getInstance();

    @Override
    public void createStudent(Student student, com.example.yazidnaufalhudzami_41522010078_tugasbesar2.database.QueryResponse<Boolean> response) {
    ...
    @Override
    public void readStudent(int studentId, com.example.yazidnaufalhudzami_41522010078_tugasbesar2.database.QueryResponse<Student> response) {
    ...
    @Override
    public void readAllStudent(com.example.yazidnaufalhudzami_41522010078_tugasbesar2.database.QueryResponse<List<Student>> response) {
        SQLiteDatabase sqLiteDatabase = databaseHelper.getReadableDatabase();
    ...
    @Override
    public void updateStudent(Student student, com.example.yazidnaufalhudzami_41522010078_tugasbesar2.database.QueryResponse<Boolean> response) {
        SQLiteDatabase sqLiteDatabase = databaseHelper.getWritableDatabase();
    ...
    @Override
    public void deleteStudent(int studentId, com.example.yazidnaufalhudzami_41522010078_tugasbesar2.database.QueryResponse<Boolean> response) {
        SQLiteDatabase sqLiteDatabase = databaseHelper.getWritableDatabase();
