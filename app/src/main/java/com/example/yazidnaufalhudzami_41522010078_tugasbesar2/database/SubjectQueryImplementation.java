...
import com.example.yazidnaufalhudzami_41522010078_tugasbesar2.model.Subject;

import java.util.ArrayList;
import java.util.List;

import static com.example.yazidnaufalhudzami_41522010078_tugasbesar2.util.Constants.SUBJECT_CODE;
import static com.example.yazidnaufalhudzami_41522010078_tugasbesar2.util.Constants.SUBJECT_CREDIT;
import static com.example.yazidnaufalhudzami_41522010078_tugasbesar2.util.Constants.SUBJECT_ID;
import static com.example.yazidnaufalhudzami_41522010078_tugasbesar2.util.Constants.SUBJECT_NAME;
import static com.example.yazidnaufalhudzami_41522010078_tugasbesar2.util.Constants.TABLE_STUDENT;
import static com.example.yazidnaufalhudzami_41522010078_tugasbesar2.util.Constants.TABLE_SUBJECT;

public class SubjectQueryImplementation implements com.example.yazidnaufalhudzami_41522010078_tugasbesar2.database.QueryContract.SubjectQuery {

    private DatabaseHelper databaseHelper = DatabaseHelper.getInstance();

    @Override
    public void createSubject(Subject subject, com.example.yazidnaufalhudzami_41522010078_tugasbesar2.database.QueryResponse<Boolean> response) {
    ...
    @Override
    public void readAllSubject(com.example.yazidnaufalhudzami_41522010078_tugasbesar2.database.QueryResponse<List<Subject>> response) {
    ...
    @Override
    public void updateSubject(Subject subject, com.example.yazidnaufalhudzami_41522010078_tugasbesar2.database.QueryResponse<Boolean> response) {
        SQLiteDatabase sqLiteDatabase = databaseHelper.getWritableDatabase();
    ...
    @Override
    public void deleteSubject(int subjectId, com.example.yazidnaufalhudzami_41522010078_tugasbesar2.database.QueryResponse<Boolean> response) {
        SQLiteDatabase sqLiteDatabase = databaseHelper.getWritableDatabase();
