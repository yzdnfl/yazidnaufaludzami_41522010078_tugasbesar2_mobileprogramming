...
import com.example.yazidnaufalhudzami_41522010078_tugasbesar2.model.TakenSubject;
...
public class TakenSubjectQueryImplementation implements com.example.yazidnaufalhudzami_41522010078_tugasbesar2.database.QueryContract.TakenSubjectQuery {

    private DatabaseHelper databaseHelper = DatabaseHelper.getInstance();

    @Override
    public void createTakenSubject(int studentId, int subjectId, com.example.yazidnaufalhudzami_41522010078_tugasbesar2.database.QueryResponse<Boolean> response) {
    ...
    @Override
    public void readAllTakenSubjectByStudentId(int studentId, com.example.yazidnaufalhudzami_41522010078_tugasbesar2.database.QueryResponse<List<Subject>> response) {
    ...
    @Override
    public void readAllSubjectWithTakenStatus(int studentId, com.example.yazidnaufalhudzami_41522010078_tugasbesar2.database.QueryResponse<List<TakenSubject>> response) {
        SQLiteDatabase sqLiteDatabase = databaseHelper.getReadableDatabase();
    ...
    @Override
    public void deleteTakenSubject(int studentId, int subjectId, com.example.yazidnaufalhudzami_41522010078_tugasbesar2.database.QueryResponse<Boolean> response) {
        SQLiteDatabase sqLiteDatabase = databaseHelper.getWritableDatabase();
