package com.example.yazidnaufalhudzami_41522010078_tugasbesar2.features.student_crud.student_list_show;
...
import com.example.yazidnaufalhudzami_41522010078_tugasbesar2.database.*;
import com.example.yazidnaufalhudzami_41522010078_tugasbesar2.features.student_crud.StudentCrudListener;
import com.example.yazidnaufalhudzami_41522010078_tugasbesar2.features.student_crud.student_update.StudentUpdateDialogFragment;
import com.example.yazidnaufalhudzami_41522010078_tugasbesar2.features.taken_subject_crud.taken_subject_show.StudentTakenSubjectActivity;
    ...
    public void onBindViewHolder(@NonNull StudentViewHolder holder, int position) {
        ...
        holder.editImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialogFragment.show(((com.example.yazidnaufalhudzami_41522010078_tugasbesar2.features.student_crud.student_list_show.StudentListActivity) context).getSupportFragmentManager(), UPDATE_STUDENT);
            }
        });
