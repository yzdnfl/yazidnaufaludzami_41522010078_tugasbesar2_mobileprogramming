package com.example.yazidnaufalhudzami_41522010078_tugasbesar2.features.subject_crud.subject_create;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        createButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                QueryContract.SubjectQuery query = new com.example.yazidnaufalhudzami_41522010078_tugasbesar2.database.SubjectQueryImplementation();
